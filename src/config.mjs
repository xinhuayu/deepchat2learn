...
export const INTERACTION_LIMIT_DEFAULTS = Object.freeze({
...
export function getInteractionLimits(env = process.env) {
  return {
    maxAnswerCharacters: parsePositiveInteger(env.MAX_ANSWER_CHARACTERS, INTERACTION_LIMIT_DEFAULTS.maxAnswerCharacters),
    maxQuestionCharacters: parsePositiveInteger(env.MAX_QUESTION_CHARACTERS, INTERACTION_LIMIT_DEFAULTS.maxQuestionCharacters)
  };
}
...
export function getVoiceConfig(env = process.env) {
  return {
    ...
    sourceDigestMaxOutputTokens: parsePositiveInteger(env.OPENAI_SOURCE_DIGEST_MAX_OUTPUT_TOKENS, VOICE_DEFAULTS.sourceDigestMaxOutputTokens),
    sourceConversationMaxOutputTokens: parsePositiveInteger(env.OPENAI_SOURCE_CONVERSATION_MAX_OUTPUT_TOKENS, VOICE_DEFAULTS.sourceConversationMaxOutputTokens),
