...
The browser check validated application state and fallback-friendly flow; it did not assert successful real microphone capture, permission grants, audio playback, mobile autoplay, or live WebRTC transport. Those require target-device testing.
...
1. It contains application source, tests, skills, documentation, editable diagrams, and the intentionally versioned system-summary PDF.
